...
class TrackCells:
        ...
        for well, df in groups:
            ...
            for prev_timepoint, current_timepoint in zip(timepoints[:-1], timepoints[1:]):
                ...
                if self.use_proximity:
                    mapping = self.run_one_timepoint_proximity()
    ...
    def run_one_timepoint_proximity(self, prev_timepoint, current_timepoint, f_prev, f_prev_mask,
